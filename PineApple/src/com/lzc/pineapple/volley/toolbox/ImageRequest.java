...
import com.lzc.pineapple.volley.ParseError;
import com.lzc.pineapple.volley.Request;
import com.lzc.pineapple.volley.Request.Method;
import com.lzc.pineapple.volley.Request.Priority;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (mMaxWidth == 0 && mMaxHeight == 0) {
            ...
            int desiredHeight = mMaxWidth * actualHeight / actualWidth;

            decodeOptions.inJustDecodeBounds = false;
            Bitmap tempBitmap = BitmapFactory.decodeByteArray(data, 0, data.length, decodeOptions);

            if (null != tempBitmap) {
                bitmap = Bitmap.createScaledBitmap(tempBitmap, mMaxWidth, desiredHeight, true);
            }
        } else {
