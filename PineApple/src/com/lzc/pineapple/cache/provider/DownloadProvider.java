...
public final class DownloadProvider extends ContentProvider {
	...
	private final class DatabaseHelper extends SQLiteOpenHelper {
		...
		private void upgradeTo(SQLiteDatabase db, int version) {
			...
			case 106:
				...
				addColumn(db, DB_TABLE, Downloads.COLUMN_SPEED_BYTES,
						"INTEGER NOT NULL DEFAULT 0");
				addColumn(db, DB_TABLE, Downloads.COLUMN_COVER,
						"TEXT");
				fillNullValues(db);
				break;
	...
	public Uri insert(final Uri uri, final ContentValues values) {
		...
		copyString(Downloads.COLUMN_COVER, values, filteredValues);
		...
		filteredValues.put(Downloads.COLUMN_SPEED_BYTES, 0);
	...
	private void checkInsertPermissions(ContentValues values) {
		...
		values.remove(Downloads.COLUMN_COVER);
